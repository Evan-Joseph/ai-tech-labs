...
本实验是为了配合《人工智能技术》课程的理论学习而专门设置，旨在巩固与加强人工智能基本原理与方法，并为后续更高级课程与信息智能化系统开发打下基础。仓库仅包含可复现实验的代码与产出（图/表），不包含报告（LaTeX/论文）文件。
...
> 每个实验包含：实验目的、实验内容、实验条件、实验要求、实验步骤和实验报告六个部分，具体要求见对应子目录 `README.md`。
